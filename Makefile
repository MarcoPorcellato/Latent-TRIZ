...
a0x-synthetic-verify:
	...
	PYTHONPATH=$(PYTHONPATH) python3 -m unittest tests.test_a0x_runner tests.test_a0x_contract_check tests.test_a0x_material tests.test_a0x_contract tests.test_a0x_preflight tests.test_a0x_activations tests.test_a0x_a0_analysis tests.test_a0x_r1_analysis tests.test_a0x_report tests.test_a0x_verify
	@echo "A0X synthetic implementation verified: no model, tokenizer, sealed target, or CCP access."

a0x-material-a0-smollm2-360m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/smollm2_360m.json

a0x-material-a0-qwen3-0-6b-base:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/qwen3_0_6b_base.json

a0x-material-a0-gpt2:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/gpt2.json

a0x-material-a0-smollm2-135m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/smollm2_135m.json

a0x-material-a0-gpt-neo-125m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/gpt_neo_125m.json

a0x-material-a0-qwen2-5-0-5b:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/a0/qwen2_5_0_5b.json

a0x-material-r1-smollm2-360m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/smollm2_360m.json

a0x-material-r1-qwen3-0-6b-base:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/qwen3_0_6b_base.json

a0x-material-r1-gpt2:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/gpt2.json

a0x-material-r1-smollm2-135m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/smollm2_135m.json

a0x-material-r1-gpt-neo-125m:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/gpt_neo_125m.json

a0x-material-r1-qwen2-5-0-5b:
	PYTHONPATH=$(PYTHONPATH) python3 scripts/a0x_material.py --fixed-dossier experiments/a0x-six-model/dossiers/r1/qwen2_5_0_5b.json
